...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			/*
			 * Variable: aUnitMenu
			 * Purpose:  List of options that can be used for the user selectable Unit menu
			 * Scope:    jQuery.dataTable.classSettings
			 * Note:     This varaible can take for form of a 1D array, in which case the value and the 
			 *   displayed value in the menu are the same, or a 2D array in which case the value comes
			 *   from the first array, and the displayed value to the end user comes from the second
			 *   array. 2D example: [ [ 10, 25, 50, 100, -1 ], [ 10, 25, 50, 100, 'All' ] ];
			 */
			this.aUnitMenu= ['KB','MB','GB','TB' ];
			
			this._dDisplayUnit = 'GB';
		...
		function _fnLanguageProcess( oSettings, oLanguage, bInit )
		{
			...
			_fnMap( oSettings.oLanguage, oLanguage, 'sUnitMenu' );
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				{
					/* Unit */
					nTmp = _fnFeatureHtmlUnit( oSettings );
					iPushFeature = 1;
                }
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" class="search_filter" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="page_num" size="1" '+sName+'>';
			var i, iLen;
		...
		this.oApi._fnFeatureHtmlUnit= _fnFeatureHtmlUnit;
		...
		return this.each(function()
		{
			...
			if ( typeof oInit != 'undefined' && oInit !== null )
			{
				...
				_fnMap( oSettings, oInit, "aUnitMenu" );                    //add by ly 2010.09
