...
function refreshVitals(xml) {
    ...
    $(ELT)("Vitals", xml).each(function getVitals(id) {
        ...
        $(ELT)("#s_distro").html("<img src='/static/theme/redmond/images/gfx/images/" + icon + "' alt='Icon' height='16' width='16' style='vertical-align:middle;' />&nbsp;" + distro);
